...
guardians_of_the_galaxy = media.Movie("Guardians of the Galaxy",
                     "Guardians of the Galaxy is a 2014 American superhero film based on the Marvel Comics superhero team of the same name, produced by Marvel Studios.",
                     "https://upload.wikimedia.org/wikipedia/en/8/8f/GOTG-poster.jpg",
                     "https://www.youtube.com/watch?v=d96cjJhvlMA")

batman_begins = media.Movie("Batman Begins",
                     "Batman Begins is a 2005 superhero film based on the DC Comics character Batman, co-written and directed by Christopher Nolan.",
...
tron = media.Movie("Tron: Legacy",
                     "Tron: Legacy is a 2010 American science fiction action film directed by Joseph Kosinski from a screenplay written by Adam Horowitz and Edward Kitsis.",
